...
public class DefinirEncaminhamento extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBarDefinirEncaminhamento);
        linearLayout = findViewById(R.id.layout_encaminhamentos);
        btnConfirmar = findViewById(R.id.btn_confirmar_encaminhamento);
