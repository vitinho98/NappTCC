package com.fatecourinhos.napp.view.senha;
...
public class RecuperarSenha extends AppCompatActivity {
    ...
    private void recuperarSenha(String email) {
        ...
        RecuperarSenhaa task = new RecuperarSenhaa();
    ...
    private class RecuperarSenhaa extends AsyncTask<RequestHttp, String, String> {
